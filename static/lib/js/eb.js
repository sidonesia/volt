const img = JSON.parse(`{{ form.my_link.img | tojson }}`)
showImageWithX(img)
...
function showImageWithX(srcEncoded) {
  ...
  if (srcEncoded) {
    ...
    <div data-show-btn class="Cur(p) Pos(r) Mend(12px)">
      ...
      <img  class="W(51px) H(37px) Ov(h) Bdrs(4px)" src="${srcEncoded}" id="picContainer" alt="" style="width:47px;height:47px">
    </div>
  `; 
