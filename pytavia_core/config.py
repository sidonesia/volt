...
G_MILLI_UNIT                      = config_json["G_MILLI_UNIT"]
G_GPIO_BATTERY_CHARGE_SETUP       = config_json["G_GPIO_BATTERY_CHARGE_SETUP"]
G_GPIO_BATTERY_CHARGE_STATE_TRUE  = config_json["G_GPIO_BATTERY_CHARGE_STATE_TRUE"]
G_GPIO_BATTERY_CHARGE_STATE_FALSE = config_json["G_GPIO_BATTERY_CHARGE_STATE_FALSE"]
G_CHARGING_TIME_TRIGGER 		  = config_json["G_CHARGING_TIME_TRIGGER"]
G_BATTERY_CHARGE_ON		 		  = config_json["G_BATTERY_CHARGE_ON"]
G_BATTERY_CHARGE_OFF	 		  = config_json["G_BATTERY_CHARGE_OFF"]
